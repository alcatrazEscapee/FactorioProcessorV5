...
def test_print(): parse('print')
def test_print_no_format_string(): parse('print_no_format_string')
def test_print_one_argument(): parse('print_one_argument')
def test_print_three_arguments(): parse('print_three_arguments')
def test_print_too_few_arguments(): parse('print_too_few_arguments')
def test_print_too_many_arguments(): parse('print_too_many_arguments')
